...
public class SettingsActivity extends PreferenceActivity {
    ...
    private CheckBoxPreference mDweetProPreference;
...
//                    getString(R.string.trace_source_file_key), null));
    ...
    protected void initializeDweetingPreferences(PreferenceManager manager) {
        ...
        mDweetProPreference = (CheckBoxPreference) manager.findPreference(getString(R.string.dweetproing_checkbox_key));

        Preference dweetproThingKeyPreference = manager.findPreference(
                getString(R.string.dweetproing_thingkey_key));
        dweetproThingKeyPreference.setOnPreferenceChangeListener(mDweetProThingKeyPreferenceListener);


        Preference dweetproThingTokenPreference = manager.findPreference(
                getString(R.string.dweetproing_thingtoken_key));
        dweetproThingTokenPreference.setOnPreferenceChangeListener(mDweetProThingTokenPreferenceListener);

        updateSummary(dweetproThingKeyPreference, preferences.getString(getString(R.string.dweetproing_thingkey_key),null));
        updateSummary(dweetproThingTokenPreference, preferences.getString(getString(R.string.dweetproing_thingtoken_key),null));
    ...
    private OnPreferenceChangeListener mDweetProThingKeyPreferenceListener =
            new OnPreferenceChangeListener() {
                public boolean onPreferenceChange(Preference preference,
                                                  Object newValue) {
                    String path = (String) newValue;
    ...
    private OnPreferenceChangeListener mDweetProThingTokenPreferenceListener =
            new OnPreferenceChangeListener() {
                public boolean onPreferenceChange(Preference preference,
                                                  Object newValue) {
                    String path = (String) newValue;
